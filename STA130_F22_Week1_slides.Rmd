---
title: "Module 1: R, Rstudio, and Jupyterhub"
...
|-:|:-|-:|
| Review [Slides](https://github.com/pointOfive/STA130) | Study for midterm and final exams | 40% |
| [Practice Questions](https://github.com/pointOfive/STA130) | Study for midterm and final exams | N/A |
| Attend Tutorials | Thursday 3:10PM ET in-person tasks | 20% | 
| Do [Homework](https://github.com/pointOfive/STA130) | Due before start of next class | 15% |
| [Coures Project](https://github.com/pointOfive/STA130) | Demonstrate your developed skills | 25% |

\vspace{-.25cm}
Boost your skills with free textbook resources like [R for Data Science](https://r4ds.had.co.nz/) by Wickham and Grolemund, free learning tools like the [DoSS Toolkit](https://dosstoolkit.com/) from STA130 profs Alexander and Caetano et al., and  online Rstudio [primers](https://rstudio.cloud/learn/primers/) and [cheatsheets](https://www.rstudio.com/resources/cheatsheets/) and [courses](https://www.datacamp.com/courses/free-introduction-to-r)
...
| Attending Tutorials | **No late or missed submissions accepted** | 20% | 
| [Homework](https://github.com/pointOfive/STA130) | **No late or missed submissions accepted** | 15% |
| [Coures Project](https://github.com/pointOfive/STA130) | **Late submissions for excused absence only** | 25% |
...
[Rstudio](https://www.rstudio.com/) is just a nice GUI IDE program that wraps up R along with a .Rmd code editor and file and data management capabilities

- GUI means "graphical user interface" while IDE means "integrated developers environment", and .Rmd files are ["R Markdowns"](https://bookdown.org/yihui/rmarkdown/) which combine text and code to create .pdf files and [presentation slides](https://bookdown.org/yihui/rmarkdown/beamer-presentation.html) ([like the ones I'm using here now](https://deic.uab.cat/~iblanes/beamer_gallery/))
...
### Knitting produces an output file by runing all .Rmd code in its directory

Code in the (top left) .Rmd window is run in the (bottom left) R console using [shortcuts](https://support.rstudio.com/hc/en-us/articles/200711853-Keyboard-Shortcuts)

### To run code-chunks use "ctrl-shift-enter" (PC) and "cmd-shift-return" (Mac)

- The code will run from the directory of the .Rmd file

### To run a single selected line of code use "ctrl-enter" and "cmd-return"

- The code will run from the current working directory
- The working directory can be set 
  - through the Session (Mac) or Tools (PC) tab in the menu bar
  - by running the code `setwd(<path/to/dir>)` in the R console
  - or with the GUI interface "gear" icon on the (bottom right) files pane


## 3. facilitating data-driven evidence-based work: Rstudio File Management
...
1. Click this [jupyterhub repo launcher link](https://jupyter.utoronto.ca/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FSamanthaJoCaetano%2FSTA130-W21-ProblemSet0.git&urlpath=rstudio%2F&branch=master)
...
1. Speak/write basic code in a human-friendly way, e.g., reading a pipe (%>%) as "and then".
4. Explain what a tibble is and what rules it follows.
5. Types vs Vectors vs Coercion vs Data frames vs read_csv() vs glimpse() and head()
