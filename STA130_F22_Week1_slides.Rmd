...
| Study/Review | [Slides](https://github.com/pointOfive/STA130), [Demos](https://github.com/pointOfive/STA130), [Questions](https://github.com/pointOfive/STA130) | N/A |
| [Participation](https://github.com/pointOfive/STA130) | Mentorship and Surveys | **5%** |
...
|-:|:-|-:|
| [Coures Project](https://github.com/pointOfive/STA130) | Due Dec 8th: Emergency Absences ONLY | 20% |
...
| 2hr [R HW](https://github.com/pointOfive/STA130) | Best 7/9 Policy + [College Registrar](https://www.artsci.utoronto.ca/current/academic-advising-and-support/college-registrars-offices) | 7% |
...
For more details on the **Best 7/9 Policy**, **Midterm reweighting**, etc.,  
please review the [grading policies](https://github.com/pointOfive/STA130/blob/main/README.md#grading) 
and [accommodation request protocols](https://github.com/pointOfive/STA130/blob/main/README.md#help).
*E.g., "7/9 policy" extensions must be requested within one week of return to UofT.*
...
currently has \href{https://cran.r-project.org/web/packages/}{18403} packages
